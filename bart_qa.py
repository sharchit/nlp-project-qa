...
def prepare_dataset(data, test_size=0.2):
    # preapre training and testing dataset
...
def compute_metrics(predictions, references):\
    # compute metrics for rouge and bertscore
    results = {}
...
def run_bart_pipeline(model_id, data, output_file='bart_results.json'):
...
if __name__ == "__main__":
    ...
    results = run_bart_pipeline("facebook/bart-large", data)
